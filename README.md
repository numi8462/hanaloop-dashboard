...
**색상 테마 및 UI 디자인**
AI의 기본적이 UI 느낌을 벗어나기 위해 컴포넌트의 UI나 색깔 테마를 직접 수정하면서 최대한 간편하면서도 편리하게 쓸 수 있는 느낌으로 구현했습니다.

**차트**
그래프 차트를 여러번 고민했었지만 누적 바 그래프와 그룹 그래프 중 둘다 사용자에 따라 보고 싶은 방식을 고를 수 있게 하는것이 더 좋은 판단이라 생각하여 "누적/그룹" 토글 기능을 추가했습니다.
...
**UI/UX 설계**
사용자 모두에게 사용하기 편하면서 접근하기 쉬운 UX를 고려해야했기 때문에 계속해서 직접 테스팅하면서 수정해야했기 때문에 시간을 좀 더 소요했습니다. 하나루프의 대시보드 디자인도 참고하면서 진행했습니다.
